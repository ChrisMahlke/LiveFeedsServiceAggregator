...
# Returns a new tuple subclass named 'PrefixSettings' with field names request and response
_PrefixSettings = collections.namedtuple('PrefixSettings', ['request', 'response'])

class PrefixSettings(_PrefixSettings):
    # __new__ returns an instance or subclass of cls
    # cls represent the classe that need to be instantiated
...
def dump_response(response, request_prefix=b'< ', response_prefix=b'> ',
    ...
    Example::
        ...
        resp = requests.get('https://www.arcgis.com')
